...
class UserProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        extra_kwargs = {
            ...
            "interests": {"required": False, "allow_blank": True, "allow_null": True},
            "goals": {"required": False, "allow_blank": True, "allow_null": True},
            "locations": {"required": False, "allow_blank": True, "allow_null": True},
            "gender": {"required": False, "allow_blank": True, "allow_null": True},
            "profession": {"required": False, "allow_blank": True, "allow_null": True},
            "photo": {"required": False, "allow_blank": True, "allow_null": True},
            "bithday": {"required": False, "allow_null": True},
            "expirience": {"required": False, "allow_null": True},
            "telegram_id": {"required": False, "allow_blank": True, "allow_null": True},
            "inerests": {"required": False, "allow_blank": True, "allow_null": True},
        }
